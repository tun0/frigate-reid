...
RUN python -c "import torch; torch.hub.load('KaiyangZhou/deep-person-reid', 'osnet_x0_25', pretrained=True, verbose=False, trust_repo=True); print('OSNet x0.25 weights cached.')"
